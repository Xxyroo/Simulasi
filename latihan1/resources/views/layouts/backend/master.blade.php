            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="./index.html" class="text-nowrap logo-img">
                        <img src="/template/src/assets/images/logos/dark-logo.svg" width="180" alt="" />
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ url('/pengaduan/create') }}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-alert-circle"></i>
                                </span>
                                <span class="hide-menu">Tambah Pengaduan</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                    ...
                    <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
                        <div class="d-flex">
                            ...
                            <div class="unlimited-access-img">
                                <img src="/template/src/assets/images/backgrounds/rocket.png" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="/template/src/assets/images/profile/user-1.jpg" alt=""
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <div class="message-body">
                                        ...
                                        <a class="dropdown-item" href="{{ route('logout') }}"
                                            ...
                                            <i class="btn btn-outline-primary mx-3 mt-2 d-block"> Logout</i>
